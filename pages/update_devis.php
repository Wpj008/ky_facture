...
<p>Modifiez les informations de ce devis.</p>
...
<form action="../traitements/traitement_devis.php" method="POST">
            ...
            <input type="text" name="numero_devis" value="<?= $devis['numero_devis']; ?>" readonly>
            ...
            <?= $customer['id_customer']==$devis['customer_id'] ? 'selected':''; ?>>
            ...
            <select name="status_devis_id">

            <?php foreach($statuts as $status): ?>

                <option
                value="<?= $status['id_status_devis']; ?>"
                <?= $status['id_status_devis']==$devis['status_devis_id'] ? 'selected':''; ?>>
                
                <?= $status['name_status_devis'] ?>
            ...
            <input type="date" name="date_creation_devis" value="<?= $devis['date_creation_devis']; ?>" readonly>
            ...
            <input type="date" name="date_validite_devis" value="<?= $devis['date_validite_devis']; ?>">
            ...
            <table class="table-ds" style="border:1px solid var(--color-border);border-radius:var(--radius-lg);overflow:hidden">
                ...
                <?php foreach($lignes_devis as $i => $ligne): ?>
                    ...
                    <input type="hidden" name="id_ligne[]" value="<?= $ligne['id_ligne_devis']; ?>">
                    <input type="hidden" name="service[]" value="<?= $ligne['service_id']; ?>">
                        ...
                        <td>
                            ...
                            <input type="number" min="1" class="qte" name="quantite[]" value="<?= (int) $ligne['quantite_devis']; ?>">
                ...
                <div class="total-wrapper">
                    ...
                    <input type="hidden" class="ligneTVA" name="montant_ttc[]" value="<?= number_format($ligne['tva'],2,'.',''); ?>">
            ...
            <a href="devis.php" class="btn-annuler">Annuler</a>

            <button type="submit" name="updating_devis" class="btn-save"><i class="bi bi-check-lg"></i>Enregistrer</button>
