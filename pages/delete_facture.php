    ...
    <main class="content">
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <h1>Supprimer une facture</h1>

                <p>Confirmez la suppression de cette facture.</p>
        ...
        <div class="card delete-card">
            ...
            <div class="resume">
                ...
                <div class="resume-item">
                    ...
                    <strong><?= $facture['firstname_customer']; ?> <?= $facture['lastname_customer']; ?></strong>
                ...
                <div class="resume-item">
                    ...
                    <strong><?= date("d/m/Y",  strtotime($facture['date_echeance_facture'])); ?></strong>
            ...
            <div class="warning">
                ...
                <span>
                    ...
                    La facture ainsi que toutes ses lignes seront supprimées définitivement.
            ...
            <form action="../traitements/traitement_facture.php" method="POST">
                ...
                <div class="actions">
                    ...
                    <button name="delete_facture" type="submit" class="btn-delete"> <i class="bi bi-trash-fill"></i>
