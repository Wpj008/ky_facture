...
<?php require_once "../partials/sidebar.php" ?>
  ...
  <header class="navbar-app">
    ...
    <div class="navbar-app__actions">
        <a href="devis.php" class="btn btn-ghost btn-sm">Annuler</a>
...
<input type="text" class="form-control-ds" name="numero_devis" value="DV-<?= date("Ymd-His"); ?>" readonly>
...
<input type="date" class="form-control-ds" name="date_creation_devis" value="<?=date('Y-m-d')?>" readonly>
...
<input type="date" class="form-control-ds" name="date_echeance_devis" required>
...
<?php foreach($statuts as $statut): ?>
  <option value="<?= $statut['id_status_devis'] ?>"><?= $statut['name_status_devis'] ?></option>
...
<input class="form-control-ds" name="quantite_devis[]" data-qty type="number" min="1" value="1" required>
