  ...
  <div class="main">
    ...
    <main class="page">
      <div class="page-header">
        <div><h1>Clients</h1><p>58 clients actifs · gérez vos contacts et leur historique.</p></div>
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newClientModal"><i class="bi bi-plus-lg"></i> Nouveau client</button>
      </div>
      ...
      <div class="table-wrap" data-paginate="#clientsTable" data-per-page="8">
        ...
        <table class="table-ds" id="clientsTable">
          <thead><tr><th>Client</th><th>Email</th><th>Factures</th><th>Catégorie</th><th>Statut</th><th></th></tr></thead>
...
<div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="../traitements/traitement_customer.php" method="POST">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <select class="form-control-ds" name="type_customer">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="create_customer" class="btn btn-primary" data-bs-dismiss="modal" > Créer le client </button>
        </div>
