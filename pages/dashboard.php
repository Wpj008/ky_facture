...
$paiementss = getPaiementsRecus();

$attente = getMontantAttente();

$nbAttente = getNombreAttente();

$retard = getMontantRetard();

$nbRetard = getNombreRetard();

$nbFacture = getNombreFacture();

$nbDevis = getNombreDevis();

$nbClient = getNombreClient();

$solde = getSoldeDisponible();

$ca10Jours = getCA10DerniersJours();

$nbPaye = getNombrePaye();

$pourcentagePaye = getPourcentagePaye();
...
<div class="main">
    <header class="navbar-app">
        ...
        <div class="navbar-app__actions">
            <a href="facture_create.php" class="btn btn-primary btn-sm d-none d-md-inline-flex">
                <i class="bi bi-plus-lg"></i> Nouvelle facture
            </a>

            <!-- Notifications -->
            <div class="dropdown">
                <button class="icon-button" data-bs-toggle="dropdown" aria-label="Notifications">
                ...
                <ul class="dropdown-menu dropdown-menu-end" style="--bs-dropdown-min-width:320px">
                    ...
                    <li>
                        <div class="notif-item">
                            <span class="notif-item__icon kpi__icon--success">
                                <i class="bi bi-check2"></i>
                            </span>

                            <div>
                                <div class="fw-medium">Paiement reçu</div>
                                <small class="text-secondary">Studio Lumière · 2 400 €</small>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="notif-item">
                            <span class="notif-item__icon kpi__icon--warning">
                                <i class="bi bi-hourglass"></i>
                            </span>

                            <div>
                                <div class="fw-medium">Devis en attente</div>
                                <small class="text-secondary">Nexa SARL · depuis 5 j</small>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="notif-item">
                            <span class="notif-item__icon kpi__icon--error">
                                <i class="bi bi-exclamation"></i>
                            </span>

                            <div>
                                <div class="fw-medium">Facture en retard</div>
                                <small class="text-secondary">Boréal Finance · 5 120 €</small>
                            </div>
                        </div>
                    </li>
            ...
            <!-- Profil -->
            <div class="dropdown">
                <button class="icon-button" data-bs-toggle="dropdown" style="width:auto;gap:8px;padding:0 8px">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item text-danger" href="../partials/logout.php">
        ...
        <div class="row g-3 section stagger">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                ...
                <div class="kpi">
                    ...
                    <div class="kpi__value text-mono">
                        <?= number_format($chiffreAffaire,2,","," ") ?> €
                    </div>
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                ...
                <div class="kpi">
                    ...
                    <div class="kpi__value text-mono">
                        <?= number_format($attente,2,","," ") ?> €
                    </div>

                    <div>
                        <span class="text-secondary">
                            <?= $nbAttente ?> factures ouvertes
                        </span>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                ...
                <div class="kpi">
                    ...
                    <div class="kpi__top">
                        ...
                        <span class="kpi__icon kpi__icon--error">
    ...
    <div class="col-lg-8">
        ...
        <div class="card-ds h-100">
            ...
            <div class="card-ds__head">
                ...
                <div class="card-ds__title">
                    <h3>Chiffre d'affaires</h3>
                    <small class="text-secondary">10 derniers jours</small>
                </div>
            ...
            foreach ($ca10Jours as $ligne)
            {
                $donnees[$ligne["jour"]] = $ligne["total"];
            }
            ...
            foreach ($graphique as $ligne)
            {
                $hauteur = ($ligne["total"] / $maxCA) * 100;
            ?>

            <div class="chart__col">

                <div class="chart__bar" style="height:<?= $hauteur ?>%"></div>

                <span class="chart__label">
                    <?= date("d/m", strtotime($ligne["jour"])) ?>
                </span>
        ...
        <div class="card-ds h-100 d-flex flex-column">
            ...
            <div class="d-flex flex-column align-items-center justify-content-center flex-grow-1">
                ...
                <div class="donut">
                    ...
                    <div class="donut__hole">
                        ...
                        <div>
                            ...
                            <div class="fw-bold" style="font-size:var(--fs-h2)">
                ...
                <div class="chart-legend mt-4 justify-content-center">
                    ...
                    <span>
                        <span class="dot" style="background:var(--color-border)"></span>
                        Retard (<?= $nbRetard ?>)
                    </span>
